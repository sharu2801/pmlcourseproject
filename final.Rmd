...
Then used random forest method with cross validation of 8-fold and sample sizes of 10304 is used to achieve and accuracy of 0.956 with 100% accuracy in predicting the 20 test cases with out of sample error of 3% using confusionMatrix
```{r}
